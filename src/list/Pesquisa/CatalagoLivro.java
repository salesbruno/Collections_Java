...
public class CatalagoLivro {
    ...
    public List<Livro> pesquisarPorAutor(String autor){
        ...
        if(!livroList.isEmpty()){
            for(Livro l : livroList){
                if(l.getAtuor().equalsIgnoreCase(autor)){
    ...
    public static void main(String[] args) {
        ...
        catalagoLivro.adicionarLivro("Livro 3", "Autor 3", 2023);
        catalagoLivro.adicionarLivro("Livro 4", "Autor 4", 1994);

        System.out.println(catalagoLivro.pesquisarPorAutor("Autor 2"));
        System.out.println(catalagoLivro.pesquisarPorIntervaloAnos(2020, 2022));
